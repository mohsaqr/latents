...
```r
multilpa_plot_types()                    # every view and what it shows
...
``` r
plot(with_predictors, what = "entropy")     # the same view on a covariate fit
```
...
``` r
plot(moves, what = "transitions")           # the estimated transition matrices
```
