...
fit <- multilpa(
  data = course_engagement, vars = vars, id = "student",
  n_profiles = 2, n_group_classes = 2, variance_model = "varying",
  n_starts = 10, seed = 1)
moves <- lta(course_engagement, vars, "student", n_group_classes = 2,
