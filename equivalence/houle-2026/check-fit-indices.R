...
#   Rscript equivalence/houle-2026/check-fit-indices.R [path/to/supplement.docx]
...
output_dir <- file.path("equivalence", "houle-2026")
...
package_values <- t(vapply(seq_len(nrow(fixture)), function(i) {
  ...
  result <- package_env$.multilpa_information_criteria(adapter, format = "long")
