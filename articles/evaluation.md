...
#> 1    1          -8440      TRUE         10       1 TRUE         1
#> 2    2          -8440      TRUE         10       1 TRUE         1
#> 3    3          -8440      TRUE         10       1 TRUE         1
```
...
#> 2  overall    lectures  attendance gaussian  0.19234        0  0.19234        1422    7.3366 NA
...
#> 5  overall      browse  forum_read gaussian  0.06266        0  0.06266        1422    2.3633 NA
#> 6  overall      browse  forum_post gaussian -0.02511        0 -0.02511        1422   -0.9462 NA
#> 7  overall      browse    lectures gaussian -0.02126        0 -0.02126        1422   -0.8011 NA
#> 8  overall  forum_read  forum_post gaussian  0.01986        0  0.01986        1422    0.7481 NA
#> 9  overall    lectures  forum_post gaussian  0.01709        0  0.01709        1422    0.6437 NA
#> 10 overall    lectures  forum_read gaussian  0.00192        0  0.00192        1422    0.0723 NA
#>     p_value p_adjusted
#> 1  1.43e-16   1.43e-16
#> 2  2.19e-13   2.19e-13
#> 3  5.77e-12   5.77e-12
...
#> 1       17010           17070      17172          17404      16996          17168      16888
#>   clc_individual
#> 1          17002
...
#>    profile indicator_1 indicator_2     kind observed expected  residual effective_n statistic df
#> 1  overall  forum_read  forum_post gaussian  0.02433  0.02431  1.37e-05        1422  5.18e-04 NA
#> 2  overall    lectures  forum_post gaussian  0.02005  0.02003  1.24e-05        1422  4.66e-04 NA
#> 3  overall  forum_post  attendance gaussian  0.18787  0.18786  1.14e-05        1422  4.45e-04 NA
#> 4  overall    lectures  forum_read gaussian  0.00883  0.00882  9.09e-06        1422  3.42e-04 NA
#> 5  overall    lectures  attendance gaussian  0.20500  0.20499  7.62e-06        1422  3.00e-04 NA
#> 6  overall      browse  forum_post gaussian -0.01869 -0.01869  7.03e-06        1422  2.65e-04 NA
#> 7  overall  forum_read  attendance gaussian  0.24178  0.24178  4.21e-06        1422  1.69e-04 NA
#> 8  overall      browse    lectures gaussian -0.01382 -0.01382  4.02e-06        1422  1.52e-04 NA
#> 9  overall      browse  forum_read gaussian  0.07443  0.07443 -1.50e-06        1422 -5.69e-05 NA
#> 10 overall      browse  attendance gaussian  0.20383  0.20383 -9.12e-07        1422 -3.58e-05 NA
#>    p_value p_adjusted
#> 1        1          1
#> 2        1          1
#> 3        1          1
...
#> Log likelihood: -8364.520998 | AIC: 16799.042 | BIC (groups): 16892.262
#> Converged: TRUE | iterations: 89 | best start: 1/3
#> 
...
#> 1  measurement     profile_1        browse        mean    0.540         0.0271      19.9  3.33e-88
#> 2  measurement     profile_1      lectures        mean    0.427         0.0325      13.2  1.55e-39
#> 3  measurement     profile_1    forum_read        mean    0.620         0.0247      25.1 1.22e-138
#> 4  measurement     profile_1    forum_post        mean    0.531         0.0295      18.0  3.65e-72
#> 5  measurement     profile_1    attendance        mean    0.649         0.0223      29.2 7.71e-187
#> 6  measurement     profile_2        browse        mean   -0.766         0.0312     -24.5 7.46e-133
#> 7  measurement     profile_2      lectures        mean   -0.606         0.0309     -19.6  1.33e-85
#> 8  measurement     profile_2    forum_read        mean   -0.879         0.0262     -33.5 1.45e-246
#> 9  measurement     profile_2    forum_post        mean   -0.753         0.0277     -27.2 8.47e-163
#> 10 measurement     profile_2    attendance        mean   -0.921         0.0264     -34.8 6.96e-266
...
#> 21     profile     profile_1 group_class_1 probability    0.170         0.0221        NA        NA
#> 22     profile     profile_2 group_class_1 probability    0.830         0.0221        NA        NA
#> 23     profile     profile_1 group_class_2 probability    0.786         0.0155        NA        NA
#> 24     profile     profile_2 group_class_2 probability    0.214         0.0155        NA        NA
...
#> 1    3.33e-88    0.486     0.593
#> 2    1.55e-39    0.364     0.491
#> 3   1.22e-138    0.571     0.668
#> 4    3.65e-72    0.473     0.588
#> 5   7.71e-187    0.605     0.693
#> 6   7.46e-133   -0.827    -0.704
#> 7    1.33e-85   -0.667    -0.546
#> 8   1.45e-246   -0.931    -0.828
#> 9   8.47e-163   -0.807    -0.698
#> 10  6.96e-266   -0.972    -0.869
#> 11         NA    0.532     0.648
#> 12         NA    0.762     0.927
#> 13         NA    0.434     0.529
#> 14         NA    0.621     0.757
...
#>          level       outcome          term   parameter estimate standard_error statistic   p_value
#> 1  measurement     profile_1        browse        mean    0.540         0.0306      17.6  1.23e-69
#> 2  measurement     profile_1      lectures        mean    0.427         0.0311      13.8  4.72e-43
#> 3  measurement     profile_1    forum_read        mean    0.620         0.0248      25.0 2.51e-138
#> 4  measurement     profile_1    forum_post        mean    0.531         0.0292      18.2  1.14e-73
#> 5  measurement     profile_1    attendance        mean    0.649         0.0235      27.6 1.51e-167
#> 6  measurement     profile_2        browse        mean   -0.766         0.0306     -25.0 4.49e-138
#> 7  measurement     profile_2      lectures        mean   -0.606         0.0355     -17.1  1.54e-65
#> 8  measurement     profile_2    forum_read        mean   -0.879         0.0267     -32.9 4.33e-237
#> 9  measurement     profile_2    forum_post        mean   -0.753         0.0274     -27.4 9.67e-166
#> 10 measurement     profile_2    attendance        mean   -0.921         0.0274     -33.6 1.67e-247
...
#> 21     profile     profile_1 group_class_1 probability    0.170         0.0328        NA        NA
#> 22     profile     profile_2 group_class_1 probability    0.830         0.0328        NA        NA
#> 23     profile     profile_1 group_class_2 probability    0.786         0.0230        NA        NA
#> 24     profile     profile_2 group_class_2 probability    0.214         0.0230        NA        NA
#> 25       group group_class_1          <NA> probability    0.325         0.0487        NA        NA
#> 26       group group_class_2          <NA> probability    0.675         0.0487        NA        NA
#>    p_adjusted conf_low conf_high
#> 1    1.23e-69    0.480     0.600
#> 2    4.72e-43    0.367     0.488
#> 3   2.51e-138    0.571     0.668
#> 4    1.14e-73    0.473     0.588
#> 5   1.51e-167    0.603     0.695
#> 6   4.49e-138   -0.826    -0.706
#> 7    1.54e-65   -0.676    -0.537
#> 8   4.33e-237   -0.932    -0.827
#> 9   9.67e-166   -0.806    -0.699
#> 10  1.67e-247   -0.974    -0.867
#> 11         NA    0.535     0.644
#> 12         NA    0.756     0.933
#> 13         NA    0.439     0.524
#> 14         NA    0.623     0.755
